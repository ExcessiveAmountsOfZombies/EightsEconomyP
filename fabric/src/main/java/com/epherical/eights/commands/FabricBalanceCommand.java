...
public class FabricBalanceCommand extends BalanceMethods {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        LiteralCommandNode<CommandSourceStack> baltopCommand = dispatcher.register(Commands.literal("baltop")
                .requires(CommonPermissionBridge.require(EightsEconMod.BALTOP, EightsEconMod.OP_BALTOP))
                .executes(BalanceMethods::balTop)
                .then(Commands.argument("page", IntegerArgumentType.integer(1)).executes(BalanceMethods::balTopPage)));
